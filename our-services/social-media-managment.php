...
<head>
    ...
    <!-- page name -->
    <title>Eliora · Social Media Managment</title>
    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-menu-frame">
            ...
            <div class="mil-frame-top">
                <a href="../" class="mil-logo">Eliora.</a>
                ...
                <div class="mil-inner-banner">
                    ...
                    <div class="mil-banner-content mil-up">
                        <div class="container">
                            ...
                            <h1 class="mil-mb-60"><b class="mil-accent">Social Media</b> <span class="mil-thin">Managment</span></h1>
                    ...
                    <div class="container mil-p-120-90">
                        <div class="row justify-content-between">
                            <div class="col-lg-4 mil-relative mil-mb-90">
                                ...
                                <p class="mil-up mil-mb-30">We help brands build a strong online presence through strategy, content creation, posting, and audience engagement. Our social media management service is designed to grow your brand, improve consistency, and turn attention into real business results.</p>
                                <!-- <div class="mil-up">
                                    <a href="portfolio-3.php" class="mil-link mil-dark mil-arrow-place">
                                        <span>View works</span>
                                    </a>
                                </div> -->
                                <div class="mil-up">
                                    <a href="../pricing.php" class="mil-link mil-dark mil-arrow-place">
                                        <span>Pricing</span>
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <!-- <h4 class="mil-up mil-mb-30 mil-accent">What’s included:</h4> -->
                                <div class="mil-accordion-group mil-up">
                                    <div class="mil-accordion-menu">
                                        <h4 class="mil-up mil-mb-10 mil-accent">What’s included:</h4>
                                        <!-- <p class="mil-accordion-head">Social media strategy development</p> -->

                                        <div class="mil-symbol mil-h3">
                                            <div class="mil-plus"><i class="fa-solid fa-angle-down"></i></div>
                                            <div class="mil-minus"><i class="fa-solid fa-angle-up"></i></div>
                                        </div>

                                    </div>
                                    <div class="mil-accordion-content">
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Social media strategy development</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Monthly content planning</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Professional video and photo content creation</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Creative scriptwriting and content ideas</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Branded post and reel design</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Content posting and scheduling</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Comment and DM management</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Performance tracking and weekly/monthly insights</p>
                                    </div>
                                ...
                                <!-- <div class="mil-accordion-group mil-up">
                                    <div class="mil-accordion-menu">
                                        ...
                                        <p class="mil-accordion-head">Monthly content planning</p>
                ...
                <!-- <section class="mil-dark-bg">
                    <div class="mi-invert-fix">
                        <div class="container mil-p-120-120">
                            ...
                            <a href="contact.php" class="mil-price-card mil-choose mil-accent-cursor mil-up">
                            ...
                            <a href="contact.php" class="mil-price-card mil-choose mil-accent-cursor mil-up mil-mb-60">
                                <div class="row align-items-center">
                                    <div class="col-lg-2">
                        ...
                        <div class="container mil-p-120-60">
                            <div class="row justify-content-between">
                                <div class="col-md-4 col-lg-4 mil-mb-60">
                                    ...
                                    <div class="mil-muted mil-logo mil-up mil-mb-30">Eliora.</div>

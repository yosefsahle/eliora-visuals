...
<head>
    ...
    <!-- page name -->
    <title>Eliora · Live Streaming Services</title>
                    ...
                    <div class="mil-banner-content mil-up">
                        <div class="container">
                            <ul class="mil-breadcrumbs mil-mb-60">
                                ...
                                <li><a href="#top">Live Streaming Services</a></li>
                            </ul>
                            <h1 class="mil-mb-60"><b class="mil-accent">Live Streaming </b><span class="mil-thin">Services</span></h1>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mil-accordion-group mil-up">
                                    ...
                                    <div class="mil-accordion-content">
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Multi-platform live streaming setup</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Streaming to Zoom, YouTube, Facebook, and other online platforms</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Screen sharing and presentation support</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Camera switching and live feed control</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Graphics, titles, and on-screen visual support</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Real-time stream monitoring</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Technical support during the live session</p>
                                        <p class="mil-mb-10"><i class="fa-solid fa-angles-right mil-accent"></i> Customized streaming setup based on event needs</p>
                                    </div>

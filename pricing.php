    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-frame">
            ...
            <div class="mil-frame-bottom">
                <div class="mil-current-page">Pricing</div>
        ...
        <div class="mil-content">
            <div id="swupMain" class="mil-main-transition">
                        ...
                        <div class="mi-invert-fix">
                            <div class="container mil-p-120-60">
                                <div class="row">
                                            ...
                                            <!-- pricing card 2: growth (highlighted) -->
                                            <!-- <div class="col-md-4 col-lg-4 mil-mb-30">
                                                <div class="mil-service-card-lg" style="background: rgba(255,215,0,0.03); padding: 30px; border: 1px solid rgba(255,215,0,0.2); position: relative;">
                                                    <span style="position: absolute; top: -10px; right: 20px; background: #caad3c; color: #0a0a0a; padding: 4px 12px; font-size: 12px; letter-spacing: 1px; border-radius: 20px;">POPULAR</span>
                                                    <div class="mil-muted mil-up mil-mb-20" style="font-size: 14px; letter-spacing: 2px;">ELIORA GOLD</div>
                                                    <h3 class="mil-muted mil-up mil-mb-20" style="line-height: 1;">26,000 ETB</h3>
                                                    <p class="mil-light-soft mil-up mil-mb-30">per month</p>
                                                    <ul class="mil-service-list mil-light mil-mb-30">
                                            ...
                                            <div class="col-md-4 col-lg-4 mil-mb-10"></div>
                                            <div class="col-md-4 col-lg-4 mil-mb-10"></div>
                                            <!-- extra note: enterprise (using col layout) -->
                ...
                <!-- call to action (same as services page) -->
                <section class="mil-soft-bg">
                    <div class="container mil-p-120-120">
                        <div class="row">
                            <div class="col-lg-10">
                                <span class="mil-suptitle mil-suptitle-right mil-suptitle-dark mil-up">Flexible plans, transparent costs — <br>let’s find the one that fits your ambition.</span>
                            </div>
                        </div>

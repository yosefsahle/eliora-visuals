...
<body>
    ...
    <div class="mil-wrapper" id="top">
        ...
        <div class="mil-frame">
            <div class="mil-frame-top">
                <a href="home-1.php" class="mil-logo">Eliora.</a>
                <div class="mil-menu-btn">
                    <span></span>
                </div>
            </div>
                    ...
                    <div class="mil-banner-content mil-up">
                        ...
                        <div class="container">
                            <ul class="mil-breadcrumbs mil-mb-60">
                                ...
                                <li><a href="portfolio-2.php">Portfolio</a></li>
                            </ul>
                    ...
                    <div class="container mil-portfolio mil-p-120-60">
                        ...
                        <div class="row justify-content-between align-items-end">
                            <div class="col-lg-6">
                                ...
                                <a href="portfolio-1.php" class="mil-portfolio-item mil-more mil-mb-60">
                            ...
                            <div class="col-lg-5">
                                ...
                                <a href="project-2.php" class="mil-portfolio-item mil-more mil-parallax mil-mb-60" data-value-1="-30" data-value-2="0">
                                    <div class="mil-cover-frame mil-hori mil-up">
                                        <div class="mil-cover">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="project-3.php" class="mil-portfolio-item mil-more mil-mb-60">
                                    <div class="mil-cover-frame mil-hori mil-up">
                                        <div class="mil-cover">
                            ...
                            <div class="col-lg-5">
                                ...
                                <a href="project-4.php" class="mil-portfolio-item mil-more mil-parallax mil-mb-60" data-value-1="-30" data-value-2="0">
                                    <div class="mil-cover-frame mil-hori mil-up">
                                        <div class="mil-cover">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="project-6.php" class="mil-portfolio-item mil-more mil-mb-60">
                                    <div class="mil-cover-frame mil-hori mil-up">
                                        <div class="mil-cover">
